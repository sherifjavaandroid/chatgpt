...
class AcademicWriterScreen extends GetWidget<AcademicWriterController> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "lbl_academic_writer".tr),
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_write_an_academic".tr,
                                        textAlign: TextAlign.center,
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_write_an_academic2".tr,
                                        textAlign: TextAlign.center,
                                        style: AppStyle.txtHeadline
                                            .copyWith(height: 1.5)),
                                  )
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_write_an_academic3".tr,
                                        textAlign: TextAlign.center,
                                        style: AppStyle.txtHeadline
                                            .copyWith(height: 1.5)),
                                  )
