...
import 'package:ai_app_flutter/widgets/text_form_field.dart';
    ...
    return SafeArea(
      ...
      body: Align(
        ...
        child: Column(
          children: [
            Obx(() {
              return controller.chatList.value == false
                  ? Expanded(
                      child: ListView(children: [
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                          ...
                                          child: Text("msg_answer_all_your".tr,
                                              overflow: TextOverflow.ellipsis,
                        ...
                        Container(
                            margin: getMargin(left: 74, top: 48, right: 74),
                            child: Text("msg_these_are_just_a".tr,
                                maxLines: null,
                                textAlign: TextAlign.center,
