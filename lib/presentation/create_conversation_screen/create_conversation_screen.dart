...
class CreateConversationScreen extends GetWidget<CreateConversationController> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "msg_create_conversation".tr),
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_write_me_a_conversation"
                                        .tr,
                                        textAlign: TextAlign.center,
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_do_me_a_two_person"
                                        .tr,
                                        textAlign: TextAlign.center,
                                        style: AppStyle.txtHeadline
                                            .copyWith(height: 1.5)),
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_give_me_a_short2"
                                        .tr,
                                        textAlign: TextAlign.center,
                                        style: AppStyle.txtHeadline
                                            .copyWith(height: 1.5)),
