...
class TranslateLanguageOneScreen
    extends GetWidget<TranslateLanguageOneController> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "msg_translate_language2".tr),
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                        "msg_translate_the_following".tr,
                                        textAlign: TextAlign.center,
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                        "msg_translate_the_following2".tr,
                                        textAlign: TextAlign.center,
                                        style: AppStyle.txtHeadline
                                            .copyWith(height: 1.5)),
                                  )
                        ...
                        Container(
                          ...
                          child: Row(
                              ...
                              children: [
                               ...
                               Expanded(
                                child: Text("msg_translate_the_following3"
                                    .tr,
                                    textAlign: TextAlign.center,
                                    style: AppStyle.txtHeadline
                                        .copyWith(height: 1.5)),
