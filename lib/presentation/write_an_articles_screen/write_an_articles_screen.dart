...
class WriteAnArticlesScreen extends GetWidget<WriteAnArticlesController> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "msg_write_an_articles2".tr),
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_write_an_article2".tr,
                                        textAlign: TextAlign.center,
                                        style: AppStyle.txtHeadline
                                            .copyWith(height: 1.5)),
                                  )
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_write_an_article3".tr,
                                        textAlign: TextAlign.center,
                                        style: AppStyle.txtHeadline
                                            .copyWith(height: 1.5)),
                                  )
