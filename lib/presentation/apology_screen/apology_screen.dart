...
class ApologyScreen extends GetWidget<ApologyController> {
  // @override
  ...
  //                   }),
  //               centerTitle: true,
  //               title: AppbarTitle(text: "lbl_apology".tr),
  ...
  //                                             margin:
  //                                                 getMargin(top: 3, right: 3),
  //                                             child: Text(
  //                                                 "msg_i_made_my_mother".tr,
  //                                                 maxLines: null,
  //                                                 textAlign: TextAlign.center,
  //                                                 style: AppStyle.txtHeadline))
  //                                       ])),
  ...
  //                         focusNode: FocusNode(),
  //                         autofocus: true,
  //                         controller: controller.groupseventythrController,
                            ...
                            Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text("msg_i_disappointed_friends"
                                            .tr,
                                            textAlign: TextAlign.center,
                                            style: AppStyle.txtHeadline
                                                .copyWith(height: 1.5)),
                            ...
                            Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text("msg_i_made_my_mother".tr,
                                            textAlign: TextAlign.center,
                                            style: AppStyle.txtHeadline
                                                .copyWith(height: 1.5)),
                                      )
                            ...
                            Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text("msg_i_dropped_my_girlfriend"
                                            .tr,
                                            textAlign: TextAlign.center,
                                            style: AppStyle.txtHeadline
                                                .copyWith(height: 1.5)),
