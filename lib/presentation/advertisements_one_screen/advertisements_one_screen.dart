...
class AdvertisementsOneScreen extends GetWidget<AdvertisementsOneController> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "lbl_advertisements".tr),
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_i_have_a_salon_service"
                                        .tr,
                                        textAlign: TextAlign.center,
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_i_want_to_write6".tr,
                                        textAlign: TextAlign.center,
                                        style: AppStyle.txtHeadline
                                            .copyWith(height: 1.5)),
                                  )
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text("msg_give_me_a_short".tr,
                                        textAlign: TextAlign.center,
                                        style: AppStyle.txtHeadline
                                            .copyWith(height: 1.5)),
                                  )
