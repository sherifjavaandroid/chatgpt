      ...
      child: SizedBox.expand(
        child: OutlinedButton(
          ...
          style: OutlinedButton.styleFrom(
            foregroundColor: effectiveForegroundColor, padding: padding,
            backgroundColor: backgroundColor, disabledForegroundColor: effectiveForegroundColor.withOpacity(0.38),
...
class SlidableAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    children.add(
      // Icon(icon),
      CustomImageView(svgPath: icon, height: getSize(20), width: getSize(20)),
    );
    ...
    //           style: AppStyle.txtFootnoteWhiteA700));
    // }
